...
encashments.fetch
  ...
  success: () ->
    ...
    #moveEntityForm tableWrapper
    addEntityFormTriggers tableWrapper

    insertAddRow tableWrapper
...
# The search bar is generated by backbone, but we position it among the html-generated elements
repositionSearch = (tableWrapper) ->
  $ ".control-row"
...
# The entity form is html-generated, but we move it among the table, which is generated in backbone
moveEntityForm = (tableWrapper) ->
  $ "##{tableWrapper} .entry-form .form-group:first-child > *"
    .wrap '<th class="to-move">'

  $ "##{tableWrapper} thead"
    .append '<tr>'

  $ "##{tableWrapper} th.to-move"
    .appendTo "##{tableWrapper} thead tr:last-child"
    .removeClass "to-move"
