...
(function() {
  var $tableWrapper, Encashment, Encashments, addColumnFiltering, addRowButtons, addSortedIndicator, alignedIntegerCell, bootstrapColumns, clearHeaderHighlights, clientSideFilter, colType, columnWidths, columns, cursorAtEndEditor, encashments, grid, highlightColumn, insertBlankRow, printError, repositionRow, setColumnWidths, setHighlightClearOnSearch, setHighlightOnSort, setInitialSortedHighlight, setSearchEscClear, setSearchIcons, setSearchSize, stringCell, sum, tableWrapper,
    slice = [].slice;
  ...
  highlightColumn = function(tableWrapper, columnIndex) {
    return $('#' + tableWrapper + ' td:nth-child(' + columnIndex + ')').add('#' + tableWrapper + ' th:nth-child(' + columnIndex + ')').toggleClass('sorted-col');
  };
  ...
  clearHeaderHighlights = function(tableWrapper) {
    return $('#' + tableWrapper + ' th.sorted-col').removeClass('sorted-col');
  };

  setHighlightClearOnSearch = function(tableWrapper) {
    return $('#' + tableWrapper + ' input[type="search"]').keyPress(function() {
      return clearHeaderHighlights(tableWrapper);
    });
  };
